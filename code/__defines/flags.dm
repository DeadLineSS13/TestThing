...
#define IN_PROGRESS 		1024
#define TWOHANDED			2048
#define WIELDED				4096
#define INITIALIZED_1		8192  	//Whether /atom/Initialize() has already run for the object
#define OVERLAY_QUEUED_1	16384	// atom queued to SSoverlay
