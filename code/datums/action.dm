...
/datum/action/proc/ApplyIcon(obj/screen/action_button/current_button)
	if(icon_icon && button_icon_state)
		current_button.cut_overlays(TRUE)
		current_button.add_overlay(icon_icon, button_icon_state)
...
/datum/action/item_action/ApplyIcon(obj/screen/action_button/current_button)
...
/datum/action/item_action/toggle_matrix
	name = "Toggle Matrix"
...
/datum/action/item_action/toggle_research_scanner/ApplyIcon(obj/screen/action_button/current_button)
	current_button.cut_overlays()
	if(button_icon && button_icon_state)
