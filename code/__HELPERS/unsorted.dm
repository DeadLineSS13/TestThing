...
/proc/parse_zone_ru(zone)
	...
	else if (zone == "head") return "������"
//	else if (zone == "groin") return "���"
	else if (zone == "r_hand") return "������ ����"
	else if (zone == "l_hand") return "����� ����"
	else if (zone == "l_arm") return "����� ����"
	else if (zone == "r_arm") return "������ ����"
	else if (zone == "l_leg") return "����� ����"
	else if (zone == "r_leg") return "������ ����"
	else if (zone == "l_foot") return "����� ����"
	else if (zone == "r_foot") return "������ ����"
	else return zone
...
var/list/WALLITEMS = list(
	/obj/machinery/power/apc,/obj/structure/sign, /obj/structure/mirror
	)
...
/proc/is_A_facing_B(atom/A,atom/B)
	...
	if(get_clockwise_dir(A.dir) == get_anticlockwise_dir(B.dir) || get_anticlockwise_dir(A.dir) == get_clockwise_dir(B.dir))
		return 1
	return 0
