...
/turf/proc/lighting_build_overlay()
	if (lighting_overlay)
		qdel(lighting_overlay,force=TRUE) //Shitty fix for lighting overlays persisting after death
...
/turf/proc/get_lumcount(var/minlum = 0, var/maxlum = 1)
	if (!lighting_overlay && !sunlighting_overlay)
		return 1
...
/turf/proc/is_softly_lit()
	...
	return max(!lighting_overlay.luminosity, !sunlighting_overlay.luminosity)
