...
/datum/sunlighting_corner/proc/update_overlays()
	...
	for (var/TT in masters)
		var/turf/T = TT
		if (T.sunlighting_overlay)
			if (!T.sunlighting_overlay.needs_update)
				T.sunlighting_overlay.needs_update = TRUE
				GLOB.sunlighting_update_overlays += T.sunlighting_overlay
