...
/obj/structure/stalker/modification_table
	...
	desc_ru = "Верстак, на котором можно модифицировать оружие и костюмы."
...
/datum/data/modification/clothing
	...
	desc_ru = "You shouldn't see this."
...
/datum/data/modification/clothing/head
	...
	desc_ru = "Это модификац&#x44F; дл&#x44F; шлема."
...
/datum/data/modification/clothing/head/material/kevlar
	name = "Kevlar padding"
	cost = 18000
	desc_ru = "Кевларовое покрытие защищает от пулевого проникновени&#x44F;." //&#x44F;
...
/datum/data/modification/clothing/head/material/composite
	...
	cost = 18000
	desc_ru = "Керамическа&#x44F; брон&#x44F; отлично защищает от взрывов и пулевого проникновени&#x44F;." //&#x44F;
...
/datum/data/modification/clothing/head/padding/psionic
	...
	cost = 15000
	desc_ru = "Нашлемный модуль защиты от псионного воздействи&#x44F;." //&#x44F;
...
/datum/data/modification/clothing/head/padding/filter
	name = "Filter module"
	cost = 15000
	desc_ru = "Установка фильтра защитит носителя от радиационного излучения." //&#x44F;
...
/datum/data/modification/clothing/head/padding/psionic_advanced
	...
	cost = 30000
	desc_ru = "Улучшенный нашлемный модуль защиты от псионного воздействи&#x44F;." //&#x44F;
...
/datum/data/modification/clothing/head/padding/filter_advanced
	...
	cost = 25000
	desc_ru = "Установка улучшенного фильтра защитит не только от радиационного излучения, но и от кислотной атмосферы и высокой температуры." //&#x44F;
...
/datum/data/modification/clothing/head/nightvision/basic
	...
	cost = 12000
	desc_ru = "Установка прибора ночного видень&#x44F; первого поколени&#x44F;."
...
/datum/data/modification/clothing/head/nightvision/advanced
	...
	cost = 25000
	desc_ru = "Установка прибора ночного видень&#x44F; второго поколени&#x44F;."
...
/datum/data/modification/clothing/head/nightvision/advanced/AffectEquipment(var/obj/item/clothing/head/Gear)
	if(!Gear.nvg)
		Gear.nvg = new /obj/item/nightvision/advanced(Gear)
	Gear.nvg.nvg_type = 1
	return ..(Gear)
...
/datum/data/modification/clothing/mask
	name = "helmet modification"
	desc_ru = "Это модификац&#x44F; дл&#x44F; маски."
...
/datum/data/modification/clothing/suit
	...
	desc_ru = "Это модификаци&#x44F; дл&#x44F; костюма."
...
/datum/data/modification/clothing/suit/lining/rubberoid
	...
	cost = 10000
	desc_ru = "Резинова&#x44F; подкладка ослабит воздействие электрического тока на тело." //&#x44F;
...
/datum/data/modification/clothing/suit/lining/thinsulate
	...
	cost = 12000
	desc_ru = "Подкладка из особого материала \"thinsulate\" обеспечит хорошую теплоизол&#x44F;цию." //&#x44F;
...
/datum/data/modification/clothing/suit/lining/nitrile
	...
	cost = 20000
	desc_ru = "Легкое соединение нитрила существенно ослабит воздействие электрического тока на тело." //&#x44F;
...
/datum/data/modification/clothing/suit/lining/fiberglass
	...
	cost = 24000
	desc_ru = "Подкладка из стекловолокна колетс&#x44F;, но обеспечивает существенную теплоизол&#x44F;цию и не обгорает." //&#x44F;
...
/datum/data/modification/clothing/suit/material/kevlar
	name = "Kevlar layer"
	cost = 15000
	desc_ru = "Дополнительный слой кевлара улучшит защиту костюма от пуль." //&#x44F;
...
/datum/data/modification/clothing/suit/material/lead
	name = "Lead layer"
	cost = 13500
	desc_ru = "Установка свинцовой пластины толщиной 4-мм улучшит радиационную защиту."
...
/datum/data/modification/clothing/suit/material/alloy
	name = "Alloy layer"
	cost = 14000
	desc_ru = "Слой комбинированной брони, созданной специально дл&#x44F; защиты жизни от воздействи&#x44F; всех опасных факторов Зоны (за исключением радиации)." //&#x44F;
...
/datum/data/modification/clothing/suit/material/composite
	...
	cost = 30000
	desc_ru = "Дополнительный слой композитной брони значительно улучшит пулестойкость, защиту костюма от взрывов и удара." //&#x44F;
...
/datum/data/modification/clothing/suit/material/wolfram
	name = "Wolfram layer"
	cost = 27000
	desc_ru = "Установка вольфрамовой пластины толщиной 2-мм значительно улучшит радиационную защиту."
...
/datum/data/modification/clothing/suit/material/alloy_advanced
	...
	cost = 28000
	desc_ru = "Улучшенна&#x44F; верси&#x44F; комбинированного слава ещё лучше защищает от вс&#x44F;кого воздействи&#x44F; Зоны (за исключением радиации)." //&#x44F;
...
/datum/data/modification/clothing/suit/padding/steelfiber
	...
	cost = 16000
	desc_ru = "Сталеволокновое покрытие защищает тело от режущего, пил&#x44F;щего и колющего воздействи&#x44F;." //&#x44F;
...
/datum/data/modification/clothing/suit/padding/neylon
	name = "Neylon padding"
	cost = 14000
	desc_ru = "Нейлоновое покрытие обеспечивает защиту от высоких температур и кислотного окружени&#x44F;." //&#x44F;
...
/datum/data/modification/clothing/suit/padding/twaron
	name = "Twaron padding"
	cost = 28000
	desc_ru = "Твёрдое, но гибкое покрытие, состо&#x44F;щее главным образом из тварона, обеспечивает серьезную защиту от любого урона в ближнем бою." //&#x44F;
...
/datum/data/modification/clothing/suit/padding/teflon
	name = "Teflon padding"
	cost = 24000
	desc_ru = "Покрытие из тефлона обеспечивает прекрасную защиту от любых кислотных факторов." //&#x44F;
...
/datum/data/modification/clothing/suit/nightvision/advanced/AffectEquipment(var/obj/item/clothing/suit/hooded/Gear)
	if(!Gear.hood.nvg)
		Gear.hood.nvg = new /obj/item/nightvision/advanced(Gear.hood)
	Gear.hood.nvg.nvg_type = 1
	return ..(Gear)
...
/datum/data/modification/clothing/suit/accessory/webbing
	...
	cost = 8000
	desc_ru = "С установкой встроенной разгрузки вы сможете носить большее количество экипировки."
...
/datum/data/modification/clothing/suit/accessory/webbing/advanced
	...
	cost = 14000
	desc_ru = "Расширение встроенной разгрузки увеличит свободное место дл&#x44F; вашего снар&#x44F;жени&#x44F;."
...
/datum/data/modification/clothing/suit/accessory/webbing/modern
	...
	cost = 22000
	desc_ru = "Расширение размеров слотов встроенной разгрузки позволит пользователю брать с собой снар&#x44F;жение большего размера."
	desc = "With the expansion of mounted webbing, the user will be able to carry extra gear."
	tier = 3
...
/datum/data/modification/clothing/suit/accessory/container
	name = "Integrated artefact Container"
	cost = 16000
	desc_ru = "С интеграцией специального контейнера артефактов пользователь возможность использовать их особые свойства."
	desc = "With the integration of specialized artefact container, user recieves ability to use their special effects."
	tier = 1
...
/datum/data/modification/clothing/suit/accessory/container/advanced
	name = "artefact Container Expansion"
	cost = 32000
	desc_ru = "Увелечение размеров интегрированного контейнера позволит пользователю переносить больше артефактов."
	desc = "Integrated container expansion allows user to carry more artefacts."
	tier = 2
...
/datum/data/modification/clothing/suit/accessory/container/modern
	name = "artefact Container Radiation Shield"
	cost = 64000
	desc_ru = "Установка радиационной защиты вокруг интегрированного контейнера."
...
/datum/data/modification/clothing/suit/accessory/guncase
	...
	cost = 32000
	desc_ru = "Установка дополнительного хранилища дл&#x44F; огнестрельного оружи&#x44F;."
...
/datum/data/modification/gun
	...
	desc_ru = "Это модификаци&#x44F; дл&#x44F; оружи&#x44F;."
	...
	if((M.id in modificated.modifications) && (M.tier == modificated.modifications[M.id] + 1))
		if(M.SpecialCheck(modificated))
			if(H.client.prefs.chat_toggles & CHAT_LANGUAGE)
				...
				dat_ += "<tr><td><b>[M.name]</b></td><td><A href='?src=\ref[src];upgrade=\ref[M]'>АПГРЕЙД</A></td></tr><tr><td style='padding-left:10px'>[M.desc_ru]</td><td>[M.cost]</td></tr>"
	return dat_
