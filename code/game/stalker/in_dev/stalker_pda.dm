...
/datum/asset/simple/kpk/encyclopedia
	assets = list(
		...
		"anomalies"				= 'icons/stalker/images/anomalies.jpg',
		"artifacts"				= 'icons/stalker/images/artifact.jpg',
		"radiation"				= 'icons/stalker/images/radiation.png',
		"mutants"				= 'icons/stalker/images/mutants.jpg',
	)
...
/obj/item/device/stalker_pda/attack_self(mob/user)
	...
	if (!owner || !password)
		...
		mainhtml += user.client.select_lang("ВВЕДИТЕ ПАРОЛЬ", "ENTER THE PASSWORD")
		...
		if (user != owner && hacked == 0)
			...
			mainhtml += user.client.select_lang("\
				 <b>Им&#x44F;:</b> [owner.real_name]<br><br>\
				 <b>Группировка:</b> [get_faction(faction_s)]<br><br>\
				 <b>Ранг:</b> [get_rank_name(rank_name_s)]<br><br>\
				 <b>Репутаци&#x44F;:</b> <font color=\"[rep_color_s]\">[get_rep_name(rep_name_s)]</font>",
				 "\
				 <b>Name:</b> [owner.real_name]<br><br>\
				 <b>Faction:</b> [faction_s]<br><br>\
				 <b>Rank:</b> [rank_name_s]<br><br>\
		...
		//ПРОФИЛЬ
				...
				if(1)
					navbarhtml = user.client.select_lang("| <a>Профиль</a> | <a href='byond://?src=\ref[src];choice=2'>Энциклопеди&#x44F;</a> | <a href='byond://?src=\ref[src];choice=3'>Рейтинг</a> | <a href='byond://?src=\ref[src];choice=4'>Лента</a> | <a href='byond://?src=\ref[src];choice=5'>Карта</a> |<br>",
					"| <a>Profile</a> | <a href='byond://?src=\ref[src];choice=2'>Encyclopedia</a> | <a href='byond://?src=\ref[src];choice=3'>Rating</a> | <a href='byond://?src=\ref[src];choice=4'>Feed</a> | <a href='byond://?src=\ref[src];choice=5'>Map</a> |<br>")
					...
					<b>Группировка:</b> [get_faction(faction_s)]<br>\
					<b>Ранг:</b> [get_rank_name(rating)] ([rating])<br>\
					<b>Репутаци&#x44F;:</b> <font color=\"[rep_color_s]\">[get_rep_name(reputation)] ([reputation])</font><br>\
					<b>Баланс:</b> [num2text(money, 8)] RU<br>",
					"\
					<b>Name:</b> [owner.real_name]<br>\
					<b>Faction:</b> [faction_s]<br>\
					<b>Rank:</b> [get_rank_name(rating)] ([rating])<br>\
					<b>Reputation:</b> <font color=\"[rep_color_s]\">[get_rep_name(reputation)] ([reputation])</font><br>\
		...
		//ЭНЦИКЛОПЕДИЯ
				...
				if(2)
					navbarhtml = user.client.select_lang("| <a href='byond://?src=\ref[src];choice=1'>Профиль</a> | <a>Энциклопеди&#x44F;</a> | <a href='byond://?src=\ref[src];choice=3'>Рейтинг</a> | <a href='byond://?src=\ref[src];choice=4'>Лента</a> | <a href='byond://?src=\ref[src];choice=5'>Карта</a> |<br>",
														"| <a href='byond://?src=\ref[src];choice=1'>Profile</a> | <a>Encyclopedia</a> | <a href='byond://?src=\ref[src];choice=3'>Rating</a> | <a href='byond://?src=\ref[src];choice=4'>Feed</a> | <a href='byond://?src=\ref[src];choice=5'>Map</a> |<br>")
										...
										<tr align=\"left\">\
											<td align=\"left\">\
												<div id=\"encyclopedia_list\">\
													...
													<h3 style=\"margin-top:0px;margin-bottom:0px\"><a href='byond://?src=\ref[src];choice=2;page=Artefacts'>Artefacts</a></h4>\
												</div>\
											</td>\
											<td valign=\"top\">\
		...
		//РЕЙТИНГ
				...
				if(3)
					navbarhtml = user.client.select_lang("| <a href='byond://?src=\ref[src];choice=1'>Профиль</a> | <a href='byond://?src=\ref[src];choice=2'>Энциклопеди&#x44F;</a> | <a>Рейтинг</a> | <a href='byond://?src=\ref[src];choice=4'>Лента</a> | <a href='byond://?src=\ref[src];choice=5'>Карта</a> |<br>",
														"| <a href='byond://?src=\ref[src];choice=1'>Profile</a> | <a href='byond://?src=\ref[src];choice=2'>Encyclopedia</a> | <a>Rating</a> | <a href='byond://?src=\ref[src];choice=4'>Feed</a> | <a href='byond://?src=\ref[src];choice=5'>Map</a> |<br>")
		...
		//ЛЕНТА
				...
				if(4)
					navbarhtml = user.client.select_lang("| <a href='byond://?src=\ref[src];choice=1'>Профиль</a> | <a href='byond://?src=\ref[src];choice=2'>Энциклопеди&#x44F;</a> | <a href='byond://?src=\ref[src];choice=3'>Рейтинг</a> | <a>Лента</a> | <a href='byond://?src=\ref[src];choice=5'>Карта</a> |<br>",
														"| <a href='byond://?src=\ref[src];choice=1'>Profile</a> | <a href='byond://?src=\ref[src];choice=2'>Encyclopedia</a> | <a href='byond://?src=\ref[src];choice=3'>Rating</a> | <a>Feed</a> | <a href='byond://?src=\ref[src];choice=5'>Map</a> |<br>")
		...
		//КАРТА
				...
				if(5)
					navbarhtml = user.client.select_lang("| <a href='byond://?src=\ref[src];choice=1'>Профиль</a> | <a href='byond://?src=\ref[src];choice=2'>Энциклопеди&#x44F;</a> | <a href='byond://?src=\ref[src];choice=3'>Рейтинг</a> | <a href='byond://?src=\ref[src];choice=4'>Лента</a> | <a>Карта</a> |<br>",
														"| <a href='byond://?src=\ref[src];choice=1'>Profile</a> | <a href='byond://?src=\ref[src];choice=2'>Encyclopedia</a> | <a href='byond://?src=\ref[src];choice=3'>Rating</a> | <a href='byond://?src=\ref[src];choice=4'>Feed</a> | <a>Map</a> |<br>")
...
//		user << browse(mainhtml, "window=mainhtml;size=568x388;border=0;can_resize=0;can_close=0;can_minimize=0;titlebar=0")
	...
	winshow(user, "pda_window", 1)
	winset(user, "pda_window", "is-visible=true")
	user << browse(mainhtml, "window=pda_window.screen_browser")
...
//				show_title = 1
		...
		if("password_input")
			...
			if(!t)
				H << H.client.select_lang("<span class='warning'>Вы не ввели пароль</span>","<span class='warning'>You entered no password.</span>")
				return

			var/datum/data/record/sk = find_record("sid", sid, GLOB.data_core.stalkers)

			if(!sk) //если человек не зарегистрирован в сети сталкеров
				password = t
				var/pass = password

				GLOB.data_core.manifest_inject(H, pass)
...
//				KPK_mobs += H
				...
				if(sk && sk.fields["pass"] != t)
					H << H.client.select_lang("<span class='warning'>Неверный пароль.</span>","<span class='warning'>Wrong password.</span>")
					return
		...
		if("lenta_add")
			...
			if(!t)
				H << H.client.select_lang( "<span class='warning'>Введите сообщение!</span>",
										"<span class='warning'>Enter the message!</span>")
			else
				if (!(last_lenta && world.time < last_lenta + LENTA_MESSAGE_COOLDOWN) )
					last_lenta = world.time

					add_lenta_message(src, sid, owner.real_name, faction_s, t)

				else
					H << H.client.select_lang("<span class='warning'>Вы сможете отправить следующее сообщение через: [round((LENTA_MESSAGE_COOLDOWN + last_lenta - world.time)/10)] сек.</span>",
											"<span class='warning'>You can't send messages in next [round((LENTA_MESSAGE_COOLDOWN + last_lenta - world.time)/10)] sec.</span>")
		...
		if("lenta_faction_add")
			...
			if(!t)
				...
				if ( !(last_faction_lenta && world.time < last_faction_lenta + LENTA_FACTION_MESSAGE_COOLDOWN) )
					...
					add_faction_lenta_message(src, sid, owner.real_name, faction_s, t)

				else
					H << H.client.select_lang("<span class='warning'>Вы сможете отправить следующее сообщение через: [round((LENTA_FACTION_MESSAGE_COOLDOWN + last_faction_lenta - world.time)/10)] сек.</span>",
												"<span class='warning'>You can't send messages in next [round((LENTA_FACTION_MESSAGE_COOLDOWN + last_faction_lenta - world.time)/10)] sec.</span>")

		if("lenta_sound")
			if(switches & FEED_SOUND)
				switches &= ~FEED_SOUND
				H << H.client.select_lang("<span class='notice'>Звук оповещения о сообщениях в ленте выключен.</span>",
										"<span class='notice'>Feed sound turned off.</span>")
			else
				switches |= FEED_SOUND
				H << H.client.select_lang("<span class='notice'>Звук оповещения о сообщениях в ленте активирован.</span>",
										"<span class='notice'>Feed sound turned on.</span>")


		if("lenta_images")
			if(switches & FEED_IMAGES)
				switches &= ~FEED_IMAGES
				H << H.client.select_lang( "<span class='notice'>Аватары сталкеров в ленте теперь не будут скачиваться.</span>",
										"<span class='notice'>Stalker avatars in the feed now will not be downloaded.</span>")
			else
				switches |= FEED_IMAGES
				H << H.client.select_lang("<span class='notice'>Аватары сталкеров в ленте теперь будут скачиваться.</span>",
										"<span class='notice'>Stalker avatars in the feed now will be downloaded.</span>")

		if("rating_images")
			if(switches & RATING_IMAGES)
				switches &= ~RATING_IMAGES
				H << H.client.select_lang("<span class='notice'>Аватары сталкеров в рейтинге теперь не будут скачиваться.</span>",
										"<span class='notice'>Stalker avatars in the rating now will not be downloaded.</span>")
			else
				switches |= RATING_IMAGES
				H << H.client.select_lang("<span class='notice'>Аватары сталкеров в рейтинге теперь будут скачиваться.</span>",
										"<span class='notice'>Stalker avatars in the rating now will be downloaded.</span>")
			...
			if(href_list["page"])
				switch(href_list["page"])
					if("Zone")
						...
						article_text = H.client.select_lang("Зона — часть территории Чернобыльской зоны отчуждения с повышенной аномальной активностью, по своим свойствам напоминающая живой организм. Она окружена охраняемым периметром, на немногих путях в неё установлены армейские блокпосты. Допуск гражданских лиц категорически запрещён, лица, нарушившие запрет, задерживаются, а при оказании вооружённого сопротивления — уничтожаются. Это не помешало искателям наживы и сорвиголовам — сталкерам в течение нескольких лет заселить и освоить Зону.",
															"The Zone of Alienation is the 60 km wide area of exclusion that was set up around the Chernobyl NPP following the 1986 disaster and extended by the second Chernobyl disaster in 2006.")
					...
					if("Anomalies")
						...
						article_img = "anomalies"
						article_img_width = 200
						article_img_height = 125
						article_text = H.client.select_lang("Аномалии — образования неизвестной природы, появившиеся в Зоне после второго взрыва. Представляют большую опасность для здоровья любого живого существа, но образуют артефакты, что заставляет многих сталкеров исследовать их.",
					...
					if("Electro")
						...
						article_img_width = 179
						article_img_height = 128
						article_text = H.client.select_lang("Аномалия легко различима в любое время суток: днём её можно опознать по голубому туману, а ночью — с помощью детектора или броском металлического предмета (также ночью можно услышать по характерным звукам и свечению). Обычно имеет около 10 метров в диаметре и накапливает в себе мощный заряд статического электричества. Потревоженная аномалия взрывается десятком мини-молний, причём поражение током для любого живого существа почти всегда смертельно. Её можно легко преодолеть простым способом: если кинуть в аномалию болт, чтобы разрядить её, то можно быстро пробежать сквозь неё, главное успеть сделать это до того, как «электра» снова наберёт заряд.",
					...
					if("Radiation")
						...
						article_img = "radiation"
						article_img_width = 179
						article_img_height = 128
						article_text = H.client.select_lang("Радиация, также известна как Очаг радиоактивности — радиоактивные пятна, оставшиеся со времён катастрофы 1986 года.По треску счётчика Гейгера можно приблизительно определить границы опасного места. Обычно фонит брошенная техника. Ближе к Центру Зоны фон нарастает.",
															"Pockets of ionizing radiation, or simply radiation for short (areas where the ambient radiation count exceeds 50 mR per hour) can be found all over the Zone. In the outside areas, radiation tends to be dominant in wide, open spaces and on piles of scrap (such as the dirt or scrap piles in Garbage. Also cars, tractors and anything mechanical). Radiation in itself doesn't form artefacts. When you have accumulated enough radiation, you'll start to lose health; although radiation will decrease by itself (albeit very slowly) when you're outside of a radioactive area, it's often a good idea to use either Vodka, antirads, or a first aid kit to speed up the process.")
					...
					if("Artefacts")
						article_title = "Artefacts"
						article_img = "artifacts"
						article_img_width = 179
						article_img_height = 128
						article_text = H.client.select_lang("Артефакт — предмет не до конца понятной физической природы, образующийся в аномалиях. Интересен в первую очередь тем, что оказывает влияние на организм носителя: как благотворное, так и вредоносное. Продажа артефактов теоретически является главным источником дохода сталкеров, большинство из которых прибыли в Зону именно за этим. В изучении свойств артефактов весьма заинтересованы учёные.",
															"Artefacts are items that have been changed by the conditions in the Zone. Most artefacts have strange and useful characteristics. For example, when kept close to the body, some artefacts create a protective field that increases its user's resilience to damage. Others may increase the user's stamina or protect against fire, etc. artefacts are also valuable scientific study material and outside corporations would pay a hefty price to obtain one of these artefacts from the zone.")
...
//			SSminimap.sendMinimaps(H)
	...
	if(href_list["invite"])
		...
		var/datum/job/J = SSjob.GetJob(get_job_title(faction_s))
		...
		for(var/obj/item/device/stalker_pda/KPK_invited in GLOB.KPKs)
			if(KPK_invited.sid == sid_)
				show_lenta_message(src, KPK_invited, sid, owner.real_name, faction_s, "You have been invited to [faction_s] faction. Check feed for more info.")
				add_local_lenta_message(src, KPK_invited, sid, owner.real_name, faction_s,"You have been invited to [faction_s] faction. <a style=\"color:#c10000;\" href='byond://?src=\ref[KPK_invited];changefaction=[J.title]'>\[Accept invitation\]</a>")
	...
	if(href_list["remove"])
		...
		for(var/obj/item/device/stalker_pda/KPK_removed in GLOB.KPKs)
			if(KPK_removed.sid == sid_)
				show_lenta_message(src, KPK_removed, sid, owner.real_name, faction_s, "You have been kicked out of [faction_s] faction.")
				add_local_lenta_message(src, KPK_removed, sid, owner.real_name, faction_s,"You have been kicked out of [faction_s] faction.")

				KPK_removed.set_owner_info(KPK_removed.profile)

	if(href_list["changefaction"])

		var/new_faction_s =  SSjob.GetJob(href_list["changefaction"]).faction_s
		var/confirm = alert(H, "Do you want to change your faction from [faction_s] to [new_faction_s]?", "KPK", "Yes", "No")
		if(confirm == "Yes")
...
/proc/add_lenta_message(var/obj/item/device/stalker_pda/KPK_owner, var/sid_owner, var/name_owner, var/faction_owner, msg, selfsound = 0)
	...
	for(var/obj/item/device/stalker_pda/KPK in GLOB.KPKs)
...
/proc/add_faction_lenta_message(var/obj/item/device/stalker_pda/KPK_owner, var/sid_owner, var/name_owner, var/faction_owner, msg, selfsound = 0)
	...
	if(KPK_owner && KPK_owner.profile && KPK_owner.profile.fields["degree"] >= 1)
		faction_title += " - leader"
	for(var/obj/item/device/stalker_pda/KPK in GLOB.KPKs)
		if(KPK_owner.faction_s != KPK.faction_s)
			continue
...
/obj/item/device/stalker_pda/proc/refresh_rating(var/mob/living/carbon/human/H)
	...
	for(var/datum/data/record/R in sortRecordNum(GLOB.data_core.stalkers, "rating", -1))
		...
		var/f = get_faction(R.fields["faction_s"])
		...
		if(degree >= 1)
			if(!R.fields["degree"])
				if(faction_s == R.fields["faction_s"])
					ratinghtml += H.client.select_lang("<a style=\"color:#c10000;\" href='byond://?src=\ref[src];remove=[sid_p]'>\[исключить\]</a>",
														"<a style=\"color:#c10000;\" href='byond://?src=\ref[src];remove=[sid_p]'>\[kick out\]</a>")
				else
					ratinghtml += H.client.select_lang("<a style=\"color:#7ac100;\" href='byond://?src=\ref[src];invite=[sid_p]'>\[пригласить\]</a>",
														"<a style=\"color:#7ac100;\" href='byond://?src=\ref[src];invite=[sid_p]'>\[invite\]</a>")
			else
				ratinghtml += H.client.select_lang("<b>\[ЛИДЕР\]</b>",
													"<b>\[LEADER\]</b>")
		//////////////
		ratinghtml += H.client.select_lang("\
				<br><b>Рейтинг:</b> [rank_name] ([r])<br>\
				<b>Репутация:</b> <font color=\"[rep_color]\">[rep]</font><br>\
				</td>\
				</tr>\
				</table>",
				"\
				<br><b>Rating</b> [rank_name] ([r])<br>\
				<b>Reputation:</b> <font color=\"[rep_color]\">[rep]</font><br>\
				</td>\
				</tr>\
				</table>")
...
/obj/item/device/stalker_pda/proc/make_avatar(var/mob/living/carbon/human/H)
	...
	if(avatar.uniform == null || avatar.shoes == null)
		H << H.client.select_lang("<span class='warning'>Вам нужно надеть свитер и ботинки перед тем, как делать фотографию!</span>","<span class='warning'>You should wear your uniform and shoes before making photo!</span>")
	else
...
/obj/item/device/stalker_pda/proc/set_owner_info(var/datum/data/record/sk)
	...
	faction_s		= get_faction(sk.fields["faction_s"])
...
/proc/get_rank_name(var/rating)
	...
	switch(rating)
		if(ZONE_LEGEND to INFINITY)
			rank_name = usr.client.select_lang("Легенда Зоны","Legend")
		if(EXPERT to ZONE_LEGEND)
			rank_name = usr.client.select_lang("Мастер","Expert")
		if(VETERAN to EXPERT)
			rank_name = usr.client.select_lang("Ветеран","Veteran")
		if(EXPERIENCED to VETERAN)
			rank_name = usr.client.select_lang("Опытный","Experienced")
		if(ROOKIE to EXPERT)
			rank_name = usr.client.select_lang("Новичок","Rookie")
	return rank_name

/proc/get_faction(var/faction)
	var/faction_s = usr.client.select_lang("Одиночки", "Loners")
	switch(faction)
		if("Bandits")
			faction_s = usr.client.select_lang("Бандиты", faction)
		if("Mercenaries")
			faction_s = usr.client.select_lang("Наёмники", faction)
		if("Duty")
			faction_s = usr.client.select_lang("Долг", faction)
		if("Traders")
			faction_s = usr.client.select_lang("Торговцы", faction)
		if("Freedom")
			faction_s = usr.client.select_lang("Свобода", faction)
		if("Monolith")
			faction_s = usr.client.select_lang("Монолит", faction)
	return faction_s

/proc/get_faction_color(var/faction)
...
/proc/get_rep_name(var/rep)
	...
	switch(rep)
		if(AMAZING to INFINITY)
			rep_name = usr.client.select_lang("Идеальная", "Perfect")
		if(VERYGOOD to AMAZING)
			rep_name = usr.client.select_lang("Очень хороша&#x44F;", "Very good")
		if(GOOD to VERYGOOD)
			rep_name = usr.client.select_lang("Хороша&#x44F;", "Good")
		if(NEUTRAL to GOOD)
			rep_name = usr.client.select_lang("Нейтральна&#x44F;", "Neutral")
		if(BAD to NEUTRAL)
			rep_name = usr.client.select_lang("Плоха&#x44F;", "Bad")
		if(VERYBAD to BAD)
			rep_name = usr.client.select_lang("Очень плоха&#x44F;", "Very bad")
		if(DISGUSTING)
			rep_name = usr.client.select_lang("Ничтожество", "Nonentity")
