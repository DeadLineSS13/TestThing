...
/obj/item/weapon/attachment/scope/SUSAT
	name = "SUSAT"
	desc_ru = "Оптический прицел фиксированной кратности (4 диоптрии). Чаще всего используется для ведения прицельного огня из лёгкого стрелкового оружия на средние и большие дистанции. Устанавливается на планку Пикатинни."
	...
	icon = 'icons/stalker/weapon_mods.dmi'
	icon_state = "susat"
	types = list(/obj/item/weapon/gun/projectile/automatic/mp5)
	zoom_add = 4
...
/obj/item/weapon/attachment/scope/rifle
	...
	icon_state = "rifle"
	types = list(/obj/item/weapon/gun/projectile/revolver/bm16,
