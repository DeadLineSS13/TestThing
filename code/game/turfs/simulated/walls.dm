...
/turf/simulated/wall/attack_hulk(mob/user)
	...
	if(prob(hardness))
		...
		playsound(src, 'sound/effects/bang.ogg', 50, 1, channel = "regular", time = 10)
...
/turf/simulated/wall/attack_hand(mob/user)
	...
	playsound(src, 'sound/weapons/Genhit.ogg', 25, 1, channel = "regular", time = 10)
...
//		return 1
	//Poster stuff
	if(istype(W,/obj/item/weapon/poster))
		place_poster(W,user)
		return 1
