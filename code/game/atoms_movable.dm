/atom/movable
	...
	var/verb_yell = "yells"
	var/verb_say_ru = "сказал"
	var/verb_ask_ru = "спросил"
	var/verb_exclaim_ru = "воскликнул"
	var/verb_yell_ru = "воскрикнул"
	var/inertia_dir = 0
	var/pass_flags = 0
...
/atom/movable/proc/throw_at(atom/target, range, speed, mob/thrower, spin=1, diagonals_first = 0, speed_sleep = 1)
