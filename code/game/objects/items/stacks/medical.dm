	...
	if(user)
		if (M != user)
			...
			user.direct_visible_message("<span class='notice'>DOER starts to apply [src] on TARGET...</span>",
										...
										"<span class='notice'>DOER начал накладывать [name_ru] на TARGET...</span>",
										"<span class='notice'>Ты начал накладывать [name_ru] на TARGET...</span>",
										"notice", user, M)
			...
			user.direct_visible_message("<span class='green'>DOER applies [src] on TARGET.</span>",
										...
										"<span class='green'>DOER наложил [name_ru] на TARGET.</span>",
										"<span class='green'>Ты наложил [name_ru] на TARGET.</span>",
										"green", user, M)
		else
			...
			user.direct_visible_message("<span class='notice'>DOER starts to apply [src] on [t_himself]...</span>",
										...
										"<span class='notice'>DOER начал накладывать [name_ru] на себя...</span>",
										"<span class='notice'>Ты начал накладывать [name_ru] на себя...</span>",
										"notice", user)
			if(!do_mob(user, M, self_delay))	return
			if(user.rolld(dice6(3), user.int+user.skills["medic"]+med_bonus))
				succss = 1
			user.direct_visible_message("<span class='green'>DOER applies [src] on [t_himself].</span>",
										...
										"<span class='green'>DOER наложил [name_ru] на себя.</span>",
										"<span class='green'>Ты наложил [name_ru] на себя.</span>",
										"green", user)
