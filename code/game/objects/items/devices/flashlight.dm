/obj/item/device/flashlight
	...
	var/sound_toggleON = 'sound/stalker/objects/items/flashlight_on.ogg'
	var/sound_toggleOFF = 'sound/stalker/objects/items/flashlight_off.ogg'
...
/obj/item/device/flashlight/proc/Toggle(mob/user)
	on = !on
	playsound(loc, on ? sound_toggleON : sound_toggleOFF, 50, 1, -5, 1, channel = "regular", time = 5)
...
/obj/item/device/flashlight/seclite/ui_action_click()
	Toggle()

/obj/item/device/flashlight/seclite/item_action_slot_check()
	return 1
...
/obj/effect/medical_holosign/New()
	playsound(loc, 'sound/machines/ping.ogg', 50, 0, channel = "regular", time = 10)
	spawn(30)
		qdel(src)
	return
...
/obj/item/device/flashlight/seclite
	...
	brightness_on = 6 // A little better than the standard flashlight.
