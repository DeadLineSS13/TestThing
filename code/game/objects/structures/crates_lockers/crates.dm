...
/obj/structure/closet/crate/open()
	playsound(src.loc, sound_effect_open, 15, 1, -3, channel = "regular", time = 5)
	dump_contents()
	src.opened = 1
	update_icon()
	return 1
...
/obj/structure/closet/crate/close()
	playsound(src.loc, sound_effect_close, 15, 1, -3, channel = "regular", time = 5)
	take_contents()
	src.opened = 0
	update_icon()
	return 1
...
/obj/structure/closet/crate/proc/tear_manifest(mob/user)
	...
	playsound(src.loc, 'sound/items/poster_ripped.ogg', 75, 1, channel = "regular", time = 10)
//	manifest.loc = loc
//	if(ishuman(user))
...
/obj/structure/closet/crate/secure/emp_act(severity)
	...
	if(!broken && !opened  && prob(50/severity))
		if(!locked)
			...
			playsound(src.loc, 'sound/effects/sparks4.ogg', 75, 1, channel = "regular", time = 10)
