...
/obj/structure/window/hitby(AM as mob|obj)
	...
	playsound(loc, 'sound/effects/Glasshit.ogg', 100, 1, channel = "regular", time = 5)
...
/obj/structure/window/attack_hand(mob/user)
	...
	playsound(loc, 'sound/effects/Glassknock.ogg', 50, 1, channel = "regular", time = 5)
...
/obj/structure/window/proc/hit(damage, sound_effect = 1)
	...
	update_nearby_icons()
	if(sound_effect)
		playsound(loc, 'sound/effects/Glasshit.ogg', 75, 1, channel = "regular", time = 5)
	if(health <= 0)
		spawnfragments()
		return
...
/obj/structure/window/Destroy()
	...
	if(!disassembled && !(flags&NODECONSTRUCT))
		playsound(src, "shatter", 70, 1, channel = "regular", time = 5)
	update_nearby_icons()
	return ..()
