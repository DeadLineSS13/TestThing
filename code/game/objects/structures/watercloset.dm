/obj/structure/stalker/toilet
	name = "toilet"
	desc = "Common rural toilet."
	desc_ru = "Обычный сельский туалет."
...
#define is_cleanable(A) (istype(A, /obj/effect/decal/cleanable))
...
/obj/structure/sink/puddle	//splishy splashy ^_^
	name = "puddle"
	desc = "Пруд выглядит чистым и не слишком ядовитым, чтобы помыть в нём что-то."
	icon_state = "puddle"
