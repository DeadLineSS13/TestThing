...
GLOBAL_LIST_INIT(contrabandposters, list(
...
GLOBAL_LIST_INIT(legitposters, list(
...
/obj/structure/sign/poster/New(serial,rolled_official)
	...
	if(!official)
		...
		name += GLOB.contrabandposters[serial_number][POSTERNAME]
		desc += GLOB.contrabandposters[serial_number][POSTERDESC]
	else if (official)
		icon_state = "poster[serial_number]_legit"
		name += GLOB.legitposters[serial_number][POSTERNAME]
		desc += GLOB.legitposters[serial_number][POSTERDESC]
	..()

/obj/structure/sign/poster/attackby(obj/item/I, mob/user, params)
	if(istype(I, /obj/item/weapon/wirecutters))
		playsound(loc, 'sound/items/Wirecutter.ogg', 100, 1, channel = "regular", time = 10)
		if(ruined)
...
/obj/structure/sign/poster/attack_hand(mob/user)
	...
	playsound(src.loc, 'sound/items/poster_ripped.ogg', 100, 1, channel = "regular", time = 10)
	ruined = 1
...
/turf/simulated/wall/proc/place_poster(obj/item/weapon/poster/P, mob/user)
	...
	playsound(D.loc, 'sound/items/poster_being_created.ogg', 100, 1, channel = "regular", time = 20)
