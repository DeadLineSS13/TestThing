...
/datum/controller/subsystem/air/Initialize(timeofday, zlevel)
/*
...
/datum/controller/subsystem/air/proc/process_super_conductivity()
/*
...
/datum/controller/subsystem/air/proc/process_high_pressure_delta()
/*
...
/datum/controller/subsystem/air/proc/process_active_turfs()
/*
	...
	if(istype(T) && T.air)
		...
		for(var/direction in cardinal)
			...
			if(istype(S))
				add_to_active(S)
*/
/datum/controller/subsystem/air/proc/process_excited_groups()
/*
...
/datum/controller/subsystem/air/proc/setup_allturfs(z_level)
/*
	var/z_start = 1
...
/datum/controller/subsystem/air/proc/setup_atmos_machinery(z_level)
/*
...
/datum/controller/subsystem/air/proc/setup_pipenets(z_level)
/*
	for (var/obj/machinery/atmospherics/AM in atmos_machinery)
		if (z_level && AM.z != z_level)
			continue
