 ...
 **/
/datum/controller/subsystem/tgui/proc/try_update_ui(mob/user, atom/movable/src_object, ui_key, datum/tgui/ui, \
  ...
  * return datum/tgui The found UI.
 **/
/datum/controller/subsystem/tgui/proc/get_open_ui(mob/user, atom/movable/src_object, ui_key)
 ...
 **/
/datum/controller/subsystem/tgui/proc/update_uis(atom/movable/src_object)
	var/src_object_key = "\ref[src_object]"
	if(isnull(open_uis[src_object_key]) || !istype(open_uis[src_object_key], /list))
 ...
 **/
/datum/controller/subsystem/tgui/proc/close_uis(atom/movable/src_object)
	var/src_object_key = "\ref[src_object]"
	if(isnull(open_uis[src_object_key]) || !istype(open_uis[src_object_key], /list))
		return 0 // Couldn't find any UIs for this object.
  ...
  * return int The number of UIs updated.
 **/
/datum/controller/subsystem/tgui/proc/update_user_uis(mob/user, atom/movable/src_object = null, ui_key = null)
  ...
  * return int The number of UIs closed.
 **/
/datum/controller/subsystem/tgui/proc/close_user_uis(mob/user, atom/movable/src_object = null, ui_key = null)
	if(isnull(user.open_uis) || !istype(user.open_uis, /list) || open_uis.len == 0)
		return 0 // Couldn't find any UIs for this user.
