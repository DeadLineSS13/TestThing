	...
	if(health >= 0)
		...
		if(lying)
			...
			M.direct_visible_message("<span class='notice'>DOER shakes TARGET trying to get them up!</span>",\
									...
									"<span class='notice'>DOER пытаетс€ помочь TARGET встать на ноги!</span>",\
									"<span class='notice'>“ы пытаешьс€ помочь TARGET встать на ноги!</span>",\
									"notice", M, src)
		else
			M.direct_visible_message("<span class='notice'>DOER hugs TARGET to make them feel better!</span>",\
									...
									"<span class='notice'>“ы обнимаешь TARGET!</span>",\
									"notice", M, src)
