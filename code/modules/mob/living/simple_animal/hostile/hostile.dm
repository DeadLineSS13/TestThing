...
//	var/deletable = 0 //Self-deletable dead bodies
	...
	var/list/armor_new = list("crush" = 0, "cut" = 0, "imp" = 0, "bullet" = 0, "burn" = 0, "bio" = 0, "rad" = 0, "psy" = 0)		//Не забудь прописать body_armor чтобы это вообще работало, ибо изначально брони НЕТ

	var/grouped = 0 					//Стайный ли мутант
	var/mob/living/leader = null		//Если стайный, то кто лидер?
	var/list/flock = list()				//Мобы в стае
...
/mob/living/simple_animal/Move(newloc)							//Эта костыльная залупа нужна чтобы выпилить диагональное передвижение мобов
