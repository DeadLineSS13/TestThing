...
/obj/item/projectile/ion/on_hit(atom/target, armor = 0)
	..()
	empulse(target, 1, 1)
	return 1
...
/obj/item/projectile/ion/weak/on_hit(atom/target, armor = 0)
	..()
	empulse(target, 0, 0)
	return 1
...
/obj/item/projectile/bullet/gyro/on_hit(atom/target, armor = 0)
	..()
...
/obj/item/projectile/bullet/a40mm/on_hit(atom/target, armor = 0)
	..()
...
/obj/item/projectile/temp/on_hit(atom/target, armor = 0)//These two could likely check temp protection on the mob
	..()
	if(isliving(target))
		var/mob/M = target
...
/obj/item/projectile/beam/mindflayer/on_hit(atom/target, armor = 0)
	. = ..()
	if(ishuman(target))
...
/obj/item/projectile/bullet/frag12/on_hit(atom/target, armor = 0)
	..()
