...
/obj/item/clothing/glasses/mob_can_equip(mob/M, slot, disable_warning = 0)
	if(!ishuman(M))
		return ..()
...
/obj/item/clothing/glasses/night
	...
	darkness_view = 7
	invis_view = SEE_INVISIBLE_OBSERVER_NOLIGHTING
	var/active = 1
	glass_colour_type = /datum/client_colour/glass_colour/green

/obj/item/clothing/glasses/night/attack_self(mob/living/carbon/user)
	if(active)
		active = 0
		...
		active = 1
		playsound(usr, 'sound/stalker/nv_start.ogg', 50, 1, -1, channel = "regular", time = 15)
...
/obj/item/clothing/glasses/equipped(mob/user, slot)
	if(slot == slot_glasses)
		user.add_client_colour(glass_colour_type)
	else
		user.remove_client_colour(glass_colour_type)