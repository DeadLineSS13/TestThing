...
var/list/g_fancy_list_of_types
...
/client/proc/cmd_debug_mob_lists()
	...
	switch(input("Which list?") in list("Players","Admins","Mobs","Living Mobs","Dead Mobs","Clients","Joined Clients"))
		if("Players")
			usr << list2text(GLOB.player_list,",")
		if("Admins")
			usr << list2text(GLOB.admins,",")
		if("Mobs")
			usr << list2text(GLOB.mob_list,",")
		if("Living Mobs")
			usr << list2text(GLOB.living_mob_list,",")
		if("Dead Mobs")
			usr << list2text(GLOB.dead_mob_list,",")
		if("Clients")
			usr << list2text(GLOB.clients,",")
		if("Joined Clients")
			usr << list2text(GLOB.joined_player_list,",")
...
/client/proc/cmd_display_del_log()
	...
	for(var/path in SSgarbage.items)
		dat += "[path] - [SSgarbage.items[path]] times<BR>"
